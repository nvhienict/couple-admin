...
class ImageSlideController extends \BaseController {
	...
	public function post_addImage()
	{
		...
		$photoslide->bigpic=Image::make(Input::file('bigpic_upload')->getRealPath())->encode('jpg',80);
		$photoslide->smallpic=Image::make(Input::file('smallpic_upload')->getRealPath())->encode('jpg',80);
		$photoslide->save();
	...
	public function update($id)
	{
		...
		$photoslide->vendor=Input::get('vendor');
		if(Input::hasfile('bigpic_upload')) $photoslide->bigpic=Image::make(Input::file('bigpic_upload')->getRealPath())->encode('jpg',80);
		if(Input::hasfile('smallpic_upload')) $photoslide->smallpic=Image::make(Input::file('smallpic_upload')->getRealPath())->encode('jpg',80);
		$photoslide->save();
